class Member:
    ...
    def sidebar_markdown(self):
        ...
        if self.linkedin_url is not None:
            markdown += f' <a href={self.linkedin_url} target="_blank"><img src="https://github.com/natcebron/test/blob/main/data/linkedin.png?raw=true" alt="linkedin" width="25" style="vertical-align: middle; margin-left: 5px"/></a> '
