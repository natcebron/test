...
def app():
    ...
    st.markdown("<p class='font'> Lien jeu de données <a href="https://www.kaggle.com/datasets/anasmohammedtahir/covidqu">COVID-QU-Ex Dataset</a>.</p>", unsafe_allow_html=True)
