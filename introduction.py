...
def app():
    ...
    st.markdown("<p class='font'> Le COVID-19 est une maladie infectieuse causée par le virus du SRAS-Cov-2. Ce virus affecte l'homme et a un tropisme pour les poumons. 
    ...
    st.markdown("<p class='font'> Dans notre étude, nous avons utilisé le dataset COVID-QU-Ex présent sur Kaggle.          
 </p>", unsafe_allow_html=True)
    st.markdown("<p class='font'> Lien jeu de données <a href="https://www.kaggle.com/datasets/anasmohammedtahir/covidqu">COVID-QU-Ex Dataset</a>.
 </p>", unsafe_allow_html=True)
