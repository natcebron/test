...
def app():
    ...
    img = Image.open("./data/graph1.png")
    ...
    img = Image.open("./data/tableau1.png")
    ...
    img = Image.open("./data/tableau2.png")
    ...
    img = Image.open("./data/tableau3.png")
    ...
    img = Image.open("./data/graph3.png")
    ...
    img = Image.open("./image_mat/tableau4.png")
    st.image(img, width=700)
