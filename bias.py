...
def app():
    ...
    st.markdown("- Fine-tuning :  l’effet dépend du modèle et des classes (ResNet50 et DenseNet201 : diminue l’impact sur la classe Normal et l’augmente sur la classe COVID-19 ; légère augmentation globale pour InceptionV3)", unsafe_allow_html=True)
